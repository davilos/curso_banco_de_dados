...
-- -----------------------------------------------------
-- Table `secao03`.`tipos_produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `secao03`.`tipos_produtos` (
...
CREATE TABLE IF NOT EXISTS `secao03`.`produtos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_idx` (`id_tipo_produto` ASC) VISIBLE,
  CONSTRAINT `fk_produtos_1`
    FOREIGN KEY (`id_tipo_produto`)
    REFERENCES `secao03`.`tipos_produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
